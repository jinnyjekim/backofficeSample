...
export function OperatingMessagesPage() {
  ...
  function resetFilters() { setQuick('전체'); setKeyword(''); setSearch(''); setTypeFilter(''); setStatusFilter(''); setChannelFilter(''); setTargetFilter(''); setDateFrom(''); setDateTo(''); }
