  ...
  return <section className={`${shared.page} ${layout.page}`}>
    ...
    <div className={layout.body}>
      ...
      <section className={layout.card}>
        ...
        <DataGrid columns={columns} rows={gridRows} gridTemplate="minmax(190px,1.5fr) 74px 56px 74px 56px 74px" minWidth="620px" empty={!rows.length} emptyText="현재 조건에 해당하는 신고 데이터가 없습니다." emptySubtext="기간 또는 조건을 변경해 주세요." emptyActionLabel="필터 초기화" emptyActionClick={reset} />
      </section>
    </div>
