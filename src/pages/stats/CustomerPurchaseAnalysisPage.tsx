    ...
    <div className={shared.headTop}>
      ...
      <div className={layout.filterCard}>
        <div className={layout.filterGrid}>
          ...
          <label className={layout.filterField}><span>고객 유형</span><select value={customerType} onChange={(e) => setCustomerType(e.target.value)}><option>전체</option><option>신규</option><option>기존</option></select></label>
