...
} from "./deliveryExtraData";

const GRID_TEMPLATE =
  "140px 140px 120px 100px 100px 140px minmax(220px, 1fr) 60px";
    ...
    <div className={styles.page}>
      ...
      {selected && (
        <DetailDrawer
          ...
          statusMeta={
            EVENT_META[selected.eventType] ?? { bg: "#f4f4f5", fg: "#52525b" }
          }
        ...
        >
          ...
          >
            배송 이력 로그는 시스템 간 통신 및 관리자 수기 조치 내역을 원본
            그대로 보존하며, 사후 수정이나 삭제가 불가한 불변(Immutable) 감사
            기록입니다.
          </div>
        </DetailDrawer>
      )}
