...
export function InventoryStatusPage({
  ...
  const allRows = useMemo(
    () => (view === "product" ? productRows(products) : skuRows(products)),
    [products, view],
  );
    ...
    >
      <div className={shared.headTop}>
        <div className={shared.headRow}>
          <div>
            <h1 className={shared.title}>{pageTitle}</h1>
            <p className={shared.subtitle}>{pageSubtitle}</p>
          </div>
        ...
        <div className={styles.viewBar}>
          ...
          <button
            type="button"
            className={view === "product" ? styles.viewActive : ""}
            onClick={() => {
              setView("product");
              setSelected([]);
              setDetailId(null);
          ...
          <button
            type="button"
            className={view === "sku" ? styles.viewActive : ""}
            onClick={() => {
              setView("sku");
              setSelected([]);
              setDetailId(null);
