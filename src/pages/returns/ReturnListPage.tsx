        ...
        >
          ...
          {isRejecting && (
            <div style={{ padding: "12px", background: "#fef2f2", border: "1px solid #fee2e2", borderRadius: "6px", marginBottom: "14px" }}>
              <div style={{ fontSize: "0.75rem", fontWeight: 600, color: "#991b1b", marginBottom: "6px" }}>반품 반려 사유 작성</div>
              <textarea
                rows={2}
                value={rejectReasonInput}
                onChange={(e) => setRejectReasonInput(e.target.value)}
                placeholder="고객 안내 및 반려 사유를 입력하세요."
                style={{ width: "100%", padding: "6px 8px", fontSize: "0.75rem", borderRadius: "4px", border: "1px solid #fca5a5" }}
              />
          ...
          {isHolding && (
            <div style={{ padding: "12px", background: "#fffbeb", border: "1px solid #fef3c7", borderRadius: "6px", marginBottom: "14px" }}>
              <div style={{ fontSize: "0.75rem", fontWeight: 600, color: "#92400e", marginBottom: "6px" }}>처리 보류 사유 작성</div>
              <textarea
                rows={2}
