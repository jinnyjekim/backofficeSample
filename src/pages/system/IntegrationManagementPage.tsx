...
export function IntegrationManagementPage() {
  ...
  const [items, setItems] = useState<SystemItem[]>(INTEGRATION_ITEMS);
    ...
    <section className={shared.page}>
      ...
      <div className={shared.filterBox} style={{ margin: "0 24px 16px" }}>
        ...
        >
          <input
            ...
            placeholder="연동 ID / 연동 서비스명 / 분류 / 담당 조직"
          />
      ...
      <GridArea>
        ...
        <DataGrid
          ...
          emptyText="조건에 맞는 외부 연동 항목이 없습니다."
      ...
      {selected && (
        <DetailDrawer
          ...
          stats={[
            { label: "운영 지표", value: selected.value },
        ...
        >
          ...
          <div className={styles.boundaryNote}>
            PG 결제, 택배사 송장, SMS 발송 등 외부 시스템과의 통신 장애 및 지연은
            고객 구매 및 서비스 운영에 직접적인 영향을 줍니다. 정기적인 헬스체크와
            장애 알림 체계를 상시 유지해야 합니다.
          </div>
        </DetailDrawer>
      )}
