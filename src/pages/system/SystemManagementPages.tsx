...
function SystemManagementPage({ kind }: { kind: SystemKind }) {
  ...
  return <section className={shared.page}><PageHeading title={config.title} subtitle={config.subtitle}/><ControlArea><div className={shared.quickFilters}>{['전체', '정상', '점검 필요', '중지'].map((status) => {
