...
export function SalesStatusPage() {
  ...
  return <div className={shared.page}>
    ...
    <ControlArea><div className={shared.quickFilters}>{STATUS_TABS.map((item) => {
