...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'settlement', icon: Scale, label: '거래처 정산 관리', to: '/settlement' },
      ...
      { key: 'products', icon: Package, label: '공급 상품 관리', to: '/products' },
      { key: 'products_list', sub: true, label: '상품 목록', to: '/products' },
